            ...
            <tr>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td>LKR <?php echo  $result->PRICE ?></td>
                          <td>LKR <output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output></td>
                        </tr>
              <?php
                        }
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  <!-- <div>Total Price : LKR <?php echo number_format($tot,2);?></div> -->
                  <!-- <div>Delivery Fee : LKR <?php echo number_format($price,2); ?></div> -->
                  <div>Overall Price : LKR <?php echo number_format($cur->TOTALPRICE,2); ?></div>
                </div>
              </div>
