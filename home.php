    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
            ...
            <div class="carousel-inner" style="background:#3cb371 !important;">
              <div class="item active">
              
              <div class="item">
                <div class="col-sm-6">
                <h1><span>ART</span>-DROP</h1>
                  <h2>Drawings | Poems | Novels | Paints</h2>
                  <p>You can order now! for your novels arts , drawings , poems.An art gallery is a room or a building in which visual art is displayed. In Western cultures from the mid-15th century, a gallery was any long, narrow covered passage along a wall, first used in the sense of a place for art in the 1590s. </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/paint.png" class="girl img-responsive" alt="" />
                </div>
              </div>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h2>LKR <?php  echo $result->PRODISPRICE; ?></h2>
                    ...
                    <div class="product-overlay" >
                      <div class="overlay-content">
                        <h3>LKR <?php  echo $result->PRODISPRICE; ?></h3>
                        <p><?php  echo    $result->PRODESC; ?></p>
