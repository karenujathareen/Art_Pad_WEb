...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
    <div class="header_top" style="background: linear-gradient(to bottom, #98ff98  50%, #98ff98  100%); !important;"><!--header_top-->
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo2.png" alt="" /></a>
            </div> 
          </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li><a href="<?php web_root?>index.php?q=about"><i class="fa fa-question-circle"></i> About US</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Art</span>-Drop</h2>
              <p>Most beautiful and atractive Art gallery. You can choose your dream Arts</p>
            </div>
          </div>
          <div class="col-sm-7">
          ...
          <div class="col-sm-3">
            <div class="companyinfo">
              <p>Art Pad <br> 3rd floor "ArtPad" 400, D.R. Wijewardena Mawatha Colombo 10</p>
            </div>
          </div>
        </div>
      </div>
